...
<div class="container container--narrow page-section">
  ...
  <?php
    /**
     * Show upcoming events for current program,
     * But without creating another 'Related Events' custom field,
     * Just use Database to query for related programs
     * Current event CONTAINS/LIKE a specific program, yes? So, return all events for this program!
     * Use front-page.php already built custom query
     */
  ...
  <li class="professor-card__list-item">
    <a class="professor-card" href="<?php the_permalink(); ?>">
      ...
      <img src="<?php the_post_thumbnail_url( 'professor-landscape' ); // the new size ?>" alt=""
